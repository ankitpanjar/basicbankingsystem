...
<body class= "bg-cover" style="background: url(img/BG1.jpeg) ">
        ...
        <div class="row intro py-1" style="background-color : #82E0AA;">
          <div class="col-sm-12 col-md">
            <div class="heading text-center my-5">
              <h3>Welcome To</h3>
              <h1>BANK OF PUBLIC</h1>
              <p>Bank Of Public(BOP) was formed in 2020.It is a leading private sector bank in the world. <br>
  ...
  <!-- Banking section -->
      ...
      <footer class="footer">
        <p> &copy 2021 Bank of Public- Made by Ankit Kumar</p>
      </footer>
